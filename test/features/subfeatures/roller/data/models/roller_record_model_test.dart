...
import 'package:flutter_eg990_mobile/features/routes/subfeatures/roller/data/models/roller_record_model.dart';
...
void main() {
  final map =
      json.decode(fixture('subfeatures/roller/get_turntable_record.json'));
