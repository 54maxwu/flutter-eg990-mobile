...
class _$_MovieModel implements _MovieModel {
  ...
  @override
  String toString() {
    return 'MovieModel(badCount: $badCount, buyCount: $buyCount, cid: $cid, content: $content, duration: $duration, goodCount: $goodCount, mid: $mid, pic: $pic, price: $price, tid: $tid, title: $title, watchCount: $watchCount, year: $year, key: $key)';
  }
