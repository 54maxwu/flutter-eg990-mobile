...
import 'package:flutter_eg990_mobile/features/general/widgets/customize_expansion_tile.dart';
import 'package:flutter_eg990_mobile/features/routes/movie/presentation/widgets/movie_category_grid_item.dart';
...
//    debugPrint('highlight widget: $key');
    try {
      ...
      debugPrint('highlight failed!! key: $key\n$e');
      return false;
    }
  }
...
//    debugPrint('header item width: $gridItemWidth, headerItemRatio: $itemRatio');
    _initIdList();
    super.initState();
  }
