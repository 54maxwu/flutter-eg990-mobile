          ...
          if (result.isSuccess) {
            callToastInfo(
                (result.msg.isNotEmpty && result.msg.hasChinese)
                    ? result.msg
                    : localeStr.agentRegisterSuccess,
                icon: Icons.check_circle_outline);
          } else if (result.msg == 'accountRepeat') {
            callToastError(localeStr.messageRepeatAccount);
          } else {
            callToastError(localeStr.messageErrorStatus(result.msg));
          }
        },
      ),
    ];
