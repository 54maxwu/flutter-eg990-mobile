...
class _BankcardDisplayCardState extends State<BankcardDisplayCard>
  ...
  void didChangeDependencies() {
    ...
    _disposers ??= [
      reaction(
        ...
        (map) {
          debugPrint('province map changed, '
          ...
          if (map.containsKey(widget.bankcard.bankProvince)) {
            ...
            debugPrint('card province: $_province');
          }
      ...
      reaction(
        ...
        (Map<String, String> map) {
          ...
          if (map.containsKey(_cityCode)) {
            ...
            debugPrint('city code substring end index: $subIndex');
            ...
            _cityCode = map.keys.firstWhere((key) {
              ...
              debugPrint('compare: $shortKey with ${widget.bankcard.bankCity}, '
            ...
            if (_cityCode.isNotEmpty) {
              ...
              _city = map[_cityCode];
              debugPrint('found city code: $_cityCode, card city: $_city');
              _waitAreaMap = true;
  ...
  void updateReadOnlyField() {
    debugPrint('wait city map: $_waitCityMap, wait area map: $_waitAreaMap');
    if (!_waitProvinceMap &&
        !_waitCityMap &&
      ...
      debugPrint('bank address detail changed: $_addressDetail');
