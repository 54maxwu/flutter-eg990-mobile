...
typedef onMemberGridItemNewTap = void Function(MemberGridItemNew);

enum _MemberGridItemType { BASIC, LINEAR }

class MemberGridItemWidgetNew extends StatelessWidget {
  final MemberGridItemNew item;
  final onMemberGridItemNewTap onItemTap;
  final _MemberGridItemType type;

  MemberGridItemWidgetNew({
    @required this.item,
    @required this.onItemTap,
  }) : this.type = _MemberGridItemType.BASIC;

  MemberGridItemWidgetNew.linearCircle({
    @required this.item,
    @required this.onItemTap,
