...
import '../data/member_grid_item_new.dart';
import '../data/member_grid_item_data.dart';

typedef onMemberGridItemNewBadgeTap = void Function(MemberGridItemNew);

enum _MemberGridItemType { BASIC, LINEAR }

class MemberGridItemWidgetNewBadge extends StatefulWidget {
  final MemberCreditStore store;
  final MemberGridItemNew item;
  final onMemberGridItemNewBadgeTap onItemTap;
  final _MemberGridItemType type;

  MemberGridItemWidgetNewBadge({
    @required this.item,
    @required this.onItemTap,
    @required this.store,
  }) : this.type = _MemberGridItemType.BASIC;

  MemberGridItemWidgetNewBadge.linearCircle({
    @required this.item,
    @required this.onItemTap,
    @required this.store,
  ...
  @override
  _MemberGridItemWidgetNewBadgeState createState() =>
      _MemberGridItemWidgetNewBadgeState();
}

class _MemberGridItemWidgetNewBadgeState
    extends State<MemberGridItemWidgetNewBadge> {
