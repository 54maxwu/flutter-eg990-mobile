...
export 'badge_position.dart';
export 'badge_shape.dart';

///
/// Widget for pub.dev
/// Origin From: https://pub.dev/packages/badges
/// Version: 1.1.3
///
/// This widget can add a animated icon upon other image.
/// Also, this can be used as badge which has smaller padding
/// then the original ones.
///
/// @samples:
///     // animate badge example
///     Badge(
...
class BadgeState extends State<Badge> with SingleTickerProviderStateMixin {
  ...
  Widget _getBadge() {
    ...
    if (widget.shape == BadgeShape.circle) {
      ...
      debugPrint('Unknown material type for badge. Used Card');
      type = MaterialType.card;
    }
