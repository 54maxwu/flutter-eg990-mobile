...
export 'package:flutter_eg990_mobile/builders/autoroute/auto_route.dart';
...
class RouterNavigate {
  ...
  static navigateBack() async {
    ...
    try {
      if (ScreenNavigate.screenIndex != 0) {
        ...
        // } else if (_previousRoute == Routes.homeRoute || _currentRoute == Routes.agentRoute) {
  ...
  /// Navigate to [FeatureRouter.homeRoute] and clean the stack
