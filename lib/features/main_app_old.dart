...
class MainAppOld extends StatefulWidget {
  final FirebaseAnalytics analytics;

  MainAppOld(this.analytics);

  @override
  State<StatefulWidget> createState() => _MainAppOldState();
}

class _MainAppOldState extends State<MainAppOld> with WidgetsBindingObserver {
