...
//    MoreGridItem.store,
  ...
  void _itemTapped(BuildContext context, RouteListItem itemValue) {
    ...
    if (itemValue.route != null) {
      ...
      } else if (itemValue.route == RoutePage.tutorial ||
          itemValue.route == RoutePage.agentAbout ||
