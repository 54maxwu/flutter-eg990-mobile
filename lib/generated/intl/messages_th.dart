...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m41(value) => "จ่าย ${value} คะแนนร้านค้า";

  static m42(value) => "ที่อยู่: ${value}";

  static m43(from, to, total) => "แสดงผลลำดับที่ ${from} ถึง ${to}, ทั้งหมดคือ ${total}";

  static m44(value) => "ชื่อ: ${value}";

  static m45(value) => "โทรศัพท์: ${value}";

  static m46(value) => "รหัสไปรษณีย์: ${value}";

  static m47(value) => "แต่ละแพลตฟอร์ม ${value}";

  static m48(value) => "${value} คะแนน";

  static m49(value) => "VDK ${value}";

  static m50(from, to) => "${from} ถึง ${to}";

  static m51(value, version) => "พบเวอร์ชันใหม่， โปรดคลิกปุ่ม \'อัปเดต\' เพื่อดาวน์โหลดและติดตั้ง\nเวอร์ชันปัจจุบัน： ${version}\nเวอร์ชันใหม่： ${value}";

  static m52(separator) => "ขอ ${separator} รหัส";

  static m53(num) => "จับฉลากได้: ${num} ครั้ง";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "storeRecordTableDetailAddress" : m42,
    "storeRecordTableDetailItem" : m43,
    "storeRecordTableDetailName" : m44,
    "storeRecordTableDetailPhone" : m45,
    "storeRecordTableDetailPostCode" : m46,
    ...
    "title" : MessageLookupByLibrary.simpleMessage("SKA888 Mobile"),
    "toolBarMemberCredit" : m49,
