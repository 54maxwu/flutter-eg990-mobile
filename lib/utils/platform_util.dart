...
class PlatformUtil {
  ...
  static const restartChannel =
      const MethodChannel('com.opkk888.mobile/restart');
  static const sensorChannel =
      const MethodChannel('com.opkk888.mobile/sensorswitch');
  static const sensorEventChannel =
      const EventChannel('com.opkk888.mobile/sensor');
  static const iosRotationChannel =
      const MethodChannel('com.opkk888.mobile/orientation');
