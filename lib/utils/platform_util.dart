...
class PlatformUtil {
  ...
  static const restartChannel =
      const MethodChannel('com.opska888.mobile/restart');
  static const sensorChannel =
      const MethodChannel('com.opska888.mobile/sensorswitch');
  static const sensorEventChannel =
      const EventChannel('com.opska888.mobile/sensor');
  static const iosRotationChannel =
      const MethodChannel('com.opska888.mobile/orientation');
