...
class PlatformUtil {
  ...
  static const restartChannel =
      const MethodChannel('com.opyabo.mobile/restart');
  static const sensorChannel =
      const MethodChannel('com.opyabo.mobile/sensorswitch');
  static const sensorEventChannel =
      const EventChannel('com.opyabo.mobile/sensor');
  static const iosRotationChannel =
      const MethodChannel('com.opyabo.mobile/orientation');
