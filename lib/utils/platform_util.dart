...
class PlatformUtil {
  ...
  static const restartChannel =
      const MethodChannel('com.opvw84.mobile/restart');
  static const sensorChannel =
      const MethodChannel('com.opvw84.mobile/sensorswitch');
  static const sensorEventChannel =
      const EventChannel('com.opvw84.mobile/sensor');
  static const iosRotationChannel =
      const MethodChannel('com.opvw84.mobile/orientation');
