...
mixin _$BankcardStore on _BankcardStore, Store {
  ...
  final _$_initDataFutureAtom = Atom(name: '_BankcardStore._initDataFuture');

  @override
  ObservableFuture<Either<Failure, BankcardModel>> get _initDataFuture {
    _$_initDataFutureAtom.reportRead();
    return super._initDataFuture;
  }

  @override
  set _initDataFuture(ObservableFuture<Either<Failure, BankcardModel>> value) {
  ...
  final _$_mobileVerifiedAtom = Atom(name: '_BankcardStore._mobileVerified');

  @override
  bool get _mobileVerified {
    _$_mobileVerifiedAtom.reportRead();
    return super._mobileVerified;
  }

  @override
  set _mobileVerified(bool value) {
    _$_mobileVerifiedAtom.reportWrite(value, super._mobileVerified, () {
      super._mobileVerified = value;
    });
  }
  ...
  final _$initializeAsyncAction = AsyncAction('_BankcardStore.initialize');
  ...
  final _$postNewCardAsyncAction = AsyncAction('_BankcardStore.postNewCard');

  @override
  Future<void> postNewCard(BankcardForm form) {
    return _$postNewCardAsyncAction.run(() => super.postNewCard(form));
  }

  final _$getVerifyCodeAsyncAction =
      AsyncAction('_BankcardStore.getVerifyCode');

  @override
  Future<bool> getVerifyCode(BankcardNewMobile form) {
    return _$getVerifyCodeAsyncAction.run(() => super.getVerifyCode(form));
  }

  final _$verifyMobileAsyncAction = AsyncAction('_BankcardStore.verifyMobile');

  @override
  Future<void> verifyMobile(BankcardNewMobile form) {
    return _$verifyMobileAsyncAction.run(() => super.verifyMobile(form));
  }
