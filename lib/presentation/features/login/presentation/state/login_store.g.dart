...
mixin _$LoginStore on _LoginStore, Store {
  ...
  final _$checkHistoryAsyncAction = AsyncAction('_LoginStore.checkHistory');

  @override
  Future<void> checkHistory() {
    return _$checkHistoryAsyncAction.run(() => super.checkHistory());
  }

  final _$loginAsyncAction = AsyncAction('_LoginStore.login');

  @override
  Future<void> login(LoginForm form) {
    return _$loginAsyncAction.run(() => super.login(form));
  }

  final _$_saveToBoxAsyncAction = AsyncAction('_LoginStore._saveToBox');

  @override
  Future<void> _saveToBox(LoginFormHive form) {
    return _$_saveToBoxAsyncAction.run(() => super._saveToBox(form));
  }

  final _$_cleanHistoryBoxAsyncAction =
      AsyncAction('_LoginStore._cleanHistoryBox');

  @override
  Future<void> _cleanHistoryBox() {
    return _$_cleanHistoryBoxAsyncAction.run(() => super._cleanHistoryBox());
  }
