...
class FailureType extends Vnum<int> {
  ...
  static const FailureType AUTH = const FailureType.define(0200);
  static const FailureType USER = const FailureType.define(0300);
  static const FailureType EVENT = const FailureType.define(0400);
  static const FailureType LOGIN = const FailureType.define(0500);
  static const FailureType REGISTER = const FailureType.define(0600);
