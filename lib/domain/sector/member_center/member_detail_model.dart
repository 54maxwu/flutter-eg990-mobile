...
import 'vip/member_vip_data.dart';

part 'member_detail_model.freezed.dart';

@freezed
abstract class MemberDetailModel with _$MemberDetailModel {
  ...
  static MemberDetailModel parseJson(Map<String, dynamic> jsonMap) =>
      _$_MemberDetailModel(
...
extension MemberDetailModelExtension on MemberDetailModel {
  ...
  MemberDetail get wrapAccountData {
    try {
      return MemberDetail(
